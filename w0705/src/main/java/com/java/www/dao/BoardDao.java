...
public class BoardDao {
	...
	String id, pw, btitle, bfile, bcontent;
	Timestamp bdate;
	...
	public ArrayList<Board> listSelectAll() {
		...
		try {
			...
			rs = pstmt.executeQuery(); // select 할때
//			pstmt.executeUpdate(); - insert,update,delete 할때
			while (rs.next()) {
				bno = rs.getInt("bno");
...
//			rs = pstmt.executeQuery(); // select 할때
			int result = pstmt.executeUpdate(); // - insert,update,delete 할때
